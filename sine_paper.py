...
plt.ylabel('sin(x)')
ax.legend()
fig.savefig("sin_4v1_train_data_paper.png")
...
title = ax.set_title("\n".join(wrap(u'Aproximando função seno com 4 neurônios RBF e variância 1.0 (10mil épocas)', 60)))
title.set_y(1.05)
fig.subplots_adjust(top=0.8)
plt.xlabel('x')
plt.ylabel('sin(x)')
ax.legend()
fig.savefig("sin_4v1_model_paper.png")